...
OUT_PATH = PRED_DIR / "rtdetr_tta_predictions.json"

MODELS = [
    ("rtdetr_predictions.json",        0.40),  # 640 (기존 best)
    ("rtdetr_imgsz800_predictions.json", 0.35), # 800 (큰 스케일)
    ("rtdetr_imgsz480_predictions.json", 0.25), # 480 (작은 스케일)
]
...
print("=" * 60)
print(" RT-DETR TTA WBF 앙상블")
print(f" 스케일: 640 + 800 + 480")
print("=" * 60)
...
for img_id in tqdm(img_ids, desc="TTA WBF"):
